...
public:
	...
	void DrawLineList(const std::vector<SDL_Point> point, const SDL_Color& color);
	...
	void DrawTriangle(const SDL_Point& v1, const SDL_Point& v2, const SDL_Point& v3, const SDL_Color& color);
